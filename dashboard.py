...
st.markdown("""
    <style>
        ...
        .stApp::after {
            ...
            z-index: 0;
            background-image: 
                radial-gradient(circle at 20% 30%, rgba(0, 212, 255, 0.05) 1px, transparent 1px),
                radial-gradient(circle at 80% 70%, rgba(0, 212, 255, 0.05) 1px, transparent 1px),
                radial-gradient(circle at 50% 50%, rgba(0, 212, 255, 0.05) 1px, transparent 1px);
